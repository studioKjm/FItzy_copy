...
제작이 프로젝트 주제입니다. 이 시스템은 사용자의 개인 성향(MBTI), 계절 및 날씨 정보,
텍스트 기반 검색 등을 종합적으로 고려한 개인화된 코디 추천을 제공하며, 실생활 패션 
관리, 온라인 쇼핑몰 추천, 스타일 및 코디 컨설팅 등 다양한 분야에서 활용 가능합니다. 
특히 실생활에서 쉽게 활용 가능한 실용적 앱으로, 계절별 날씨에 맞는 코디부터 개인의 
성향에 맞는 스타일링까지 제공합니다.
